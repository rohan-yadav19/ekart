    ...
    <footer className="bg-gray-900 text-gray-200 py-10">
      <div className="max-w-7xl mx-auto px-4 md:flex md:justify-between">
        ...
        <div className="mb-6 md:mb-0">
          ...
          <p className="mt-2 text-sm">123 Business Park, Suite 100</p>
          <p className="text-sm">Email: info@ekart.com</p>
        ...
        <div>
          ...
          <p>Subscribe to get special offers, free giveways, and more </p>
